...
const WinnerDetails = ({ bidAmount, username, id }) => {
  return (
    <>
      <div className="winner_details-container">
        <div className="cards">
          ...
          <div className="detailPage">
            <div className="gradesBox">
              ...
              <div>
                <p className="gradesBoxLabel">Amount</p>
                <p className="gradesBoxNum">${bidAmount}</p>
              </div>
            </div>
            <svg
